...
{[
  { title: "プログラミング及び実習2", icon: "terminal", tags: ["1年後期", "選択必修", "教職（情報）必修"], href: "https://sanoakr.github.io/rumath-prog2/" },
  { title: "ネットワーク及び演習", icon: "network", tags: ["3年3Q", "選択科目", "教職（情報）必修"], href: "https://sanoakr.github.io/rumath-network/" },
...
- [aiJudge](https://judge.math.ryukoku.ac.jp/)（[利用ガイド](https://sanoakr.github.io/aijudge/)）
